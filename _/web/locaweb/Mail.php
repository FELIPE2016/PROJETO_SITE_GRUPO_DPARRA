...
if (isset($_POST['txtdest']))
{
	...
	$headers .= "From: contato@grupodparra.com.br".$quebra; //E-mail do remetente
	$headers .= "Return-Path: contato@grupodparra.com.br".$quebra; //E-mail do remetente
	mail($destino, $assunto, $mensagem, $headers, "-r". "contato@grupodparra.com.br");
